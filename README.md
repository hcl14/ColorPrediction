...
Tha dataset *spring-Pantone_TPX_RGB_Colours.csv* contains Pantone palettes for spring season for years 2003-2016. Year 2003 contains 9 values, other years contain 10 values. For year 2015 Pantone released two color sets for Men and Women, the Women data is used.

*convert_to_16.R* contains the code that rounds the values to 16-color palette. For missing value simple imputation is used.
Output:
